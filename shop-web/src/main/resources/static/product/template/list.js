    ...
    class autotable {
        ...
        addToolbar(data){
            ...
            layer.open({
                ...
                type : 2,
                title : "添加",
                content : '/static/product/template/update.html?_mkbm='+mkbm,
                maxmin : !0,
                area :  ['95%', '95%'],
                btn : ['确认','取消'],
        ...
        updOperation(data){
            ...
            layer.open({
                ...
                type : 2,
                title : "修改",
                content : '/static/product/template/update.html?_mkbm='+mkbm+'&id='+data[zjzd],
                maxmin : !0,
                area :  ['95%', '95%'],
                btn : ['确认','取消'],
                yes : function(index, layero) {
        ...
        detailOperation(data){
            ...
            layer.open({
                ...
                type: 2,
                title: "修改",
                content: './view.html?_mkbm=' + mkbm + '&id=' +data[zjzd],
                maxmin: !0,
                area: ['95%', '95%'],
                btn: ['确认'],
                yes: function (index, layero) {
        ...
        setSearchSelect(item, form) {
            ...
            let title = item.searchtitle.toLowerCase();
            let formItem = this.getFormItem();
            formItem.html("<label class=\"layui-form-label\">" + title + "</label><div class=\"layui-input-inline\" style=\"width: 200px;\"><select readonly name=\"" + name + "\"></select></div>")
            formItem.appendTo(form);
        }
